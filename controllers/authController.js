...
exports.login = catchAsync(async (req, res, next) => {
  ...
  if (!email || !password) {
    next(new AppError('Please provide an email end password!', 400));
  }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  console.log(req.user.passwordCurrent, user.password);

  //2)Check so if posted current password is correct
